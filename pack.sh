...
function runmain(){
	...
	$MKISOTOOL -iso-level 3 -r -V sblive -cache-inodes -J -l -b syslinux/isolinux.bin -no-emul-boot -boot-load-size 4 -boot-info-table -c syslinux/boot.cat -o test.iso isofs
}
